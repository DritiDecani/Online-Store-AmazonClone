                        ...
                        <div class="centerCol">
                            ...
                            <div class="mediaMatirx">
                                <div class="formats">
                                    ...
                                    <ul>
                                        <!-- Kindle -->
                                        <li class="swatchElements" style="width: 117px;">
                                            <span class="a-list-item">
                                            ...
                                            <span class="a-list-item">
                                                ...
                                                <span class="tmm-olp-links">
                                                    <a href="#" class="a-size-mini">
                                                        <span class="kcpAppBox">
                                                            <span class="a-declarative">
                                                                <span class="a-text-bold">Free App</span> with your Audible Trail
                                                            </span>
                                                        </span>
                                                    </a>
                                                </span>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 mb-1">
                                        <div class="a-declarative">
                                            Length: <span><a href="#">386 pagers <i class="a-icon a-icon-popover"></i></a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>   
                        ...
                        <div class="combinedBuyBox">
                            <div class="buyBox">
                                ...
                                <div class="a-section a-spacing-small a-spacing-top-micro">
                                    <div class="row">
                                        <span class="a-class-base buyboxShippingLabel"></span>
                                    </div>
                                </div>
                                ...
                                <span class="a-declarative">
                                    <a href="#" class="a-link-normal">
                                        <div class="a-row a-spacing-mini">
                                            ...
                                            <span class="a-size-small">Deliver to Kosovo</span>
                                        </div>
                                    </a>
                                </span>
                                <br>
